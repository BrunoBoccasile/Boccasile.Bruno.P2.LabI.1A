 ...
 * \return nuevo puntero a LinkedList con los elementos que paso la funcion
 *
 */
...
/** \brief Recibe una lista y una funcion a la cual se le pasan los elementos de la lista
 *
 * \param LinkedList* this LinkedList a mapear
 * \param void*(*pFunc) (void*) puntero a la funcion
 * \return Retorna la lista resultado del mapeo
 *
 */
...
LinkedList* ll_map(LinkedList* this, void*(*pFunc) (void* element))
{
    ...
    if(this !=NULL && pFunc != NULL)
    {
        ...
        listaResultado = ll_clone(this);

        for(int i=0;i<ll_len(this);i++)
        {

            pElement = ll_get(listaResultado,i);
